...
public class EnchantingTableInventoryImpl extends EnchantingTableInventory {
    ...
    public void openInventory(@NotNull Player player, @NotNull TextHolder title,
        ...
        PacketPlayOutOpenWindow packet = new PacketPlayOutOpenWindow(id, "minecraft:enchantment", message);
    ...
    private class ContainerEnchantingTableImpl extends ContainerEnchantTable {
        ...
        public CraftInventoryView getBukkitView() {
            if (bukkitEntity == null) {
                try {
                    CraftInventory inventory = new CraftInventoryEnchanting((InventorySubcontainer) enchantSlotsField.get(this)) {
                        @NotNull
                        @Contract(pure = true)
                        @Override
